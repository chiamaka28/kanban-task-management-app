...
export default function DashboardLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className='grid grid-cols-[250px_1fr] min-h-screen'>
      {/* Shared Sidebar */}
      <aside className='bg-white border-r border-grey  py-6'>
        <div className='flex flex-col  items-start mb-4 '>
          ...
          <span className='text-grey-border text-xs px-8 font-bold  py-1'>
            ...
            {Boards.map((board) => (
              ...
              >
                <Link
                  ...
                  className={`flex items-center gap-4 py-3.5 px-8 rounded-br-4xl  rounded-tr-4xl ${
                    activeBoard === board?.id
                      ? 'bg-primary text-white'
                      : 'bg-white text-grey-border'
                  } hover:bg-gray-100 transition-colors duration-150`}
                >
                  <Image
                    src={`/assets/${
                      activeBoard === board?.id ? 'boardIcon' : 'greyBoard'
                    }.svg`}
                    alt='Board Icon'
                    width={16}
                    height={16}
        ...
        <div>
          <div className='flex items-center mx-6 max-w-[215px] h-12 justify-center gap-6 bg-secondary'>
            <Image
