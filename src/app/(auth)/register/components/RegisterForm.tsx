...
export default function RegisterForm() {
  return (
    <div className='w-[90%]  md:max-w-[376px] mx-auto px-2 py-14'>
        ...
        <div className='flex flex-col gap-2'>
          ...
          <div className='flex items-center gap-2'>
            ...
            <div className='grid gap-2'>
              <Label
                htmlFor='terms-2 '
                className='text-xs text-grey-border font-bold'
              >
        ...
        <div>
          <Button variant='destructive' size='default'>
            <Image
              ...
              style={{ width: 20, height: 20 }}
            />
            <span className='md:hidden'>Continue with Apple</span>
          </Button>
        </div>
        <div>
          <Button variant='destructive' size='default'>
            <Image
              ...
              style={{ width: 20, height: 20 }}
            />
            <span className='md:hidden'>Continue as a Guest</span>
          </Button>
        </div>
      </div>
    </div>
